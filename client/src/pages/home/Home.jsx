...
const Home = () => {
    const isQHD = useMediaQuery(useTheme().breakpoints.up('lg'), {noSsr: true});
    // useMediaQuery: min-width = window.innerWidth
    // const intViewportWidth = window.innerWidth;

    return (
        <Wrapper>
            <Box height="100%" sx={{bgcolor: "#FDFDFD"}}>
                ...
                {isQHD &&
                    <Grid container className={classes.w3_slide_bottom} gap={2} mt={16} mb={16}>
                        <Grid item xs={0} md={2} lg={2}/>
                        <Grid item container xs={12} md={5} lg={5} textAlign={["center", "center", "start"]}>
                            <Grid item xs={12}>
                            ...
                            <Grid item xs={12}>
                                <Button LinkComponent={RouterLink} to="/auth/register" color="hOrange"
                                        variant="contained">
                                    Sign up now!
                                </Button>
                            </Grid>
                        </Grid>
                        <Grid item container xs={12} md={3} lg={3} marginLeft={[0, 0, 0, 2]}
                              marginTop={[6, 6, 6, 0, 0]}>
                ...
                {!isQHD &&
                    <Grid container className={classes.w3_slide_bottom} gap={2} mt={12} mb={11}>
                        <Grid item xs={0} md={2} lg={2}/>
                        <Grid item container xs={12} md={5} lg={5} textAlign={["center", "center", "start"]}>
                            <Grid item xs={12}>
                                <Typography variant="h1" fontSize="4em">
                ...
                <Typography textAlign="center" color="silver" variant="h6" fontSize="0.875em">CSCI3100 2021-2022 Spring
                    Group Project</Typography>
            </Box>
        </Wrapper>
    );
};
