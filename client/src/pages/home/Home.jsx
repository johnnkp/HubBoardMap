...
const OrangeText = styled("span")(({theme}) => ({
    color: theme.palette.hOrange.main, fontWeight: "bolder",
}));
...
=======
    const isQHD = useMediaQuery(useTheme().breakpoints.up('lg'));
            ...
            <Box height="100%">
                <Grid container mt="1em">
                    ...
                    >
                        <Box
                            ...
                            alignItems="center"
                            sx={{
                                transition: "all 0.4s ease-out", "&:hover": {transform: "scale(1.2)"},
                            }}
                        >
                            <img src={HubBoardIcon} height="75px" alt="HubBoard Icon"/>
                            <Typography fontSize="1.7em" ml={[0, 2, 4]}>
                ...
                <Grid container className={classes.w3_slide_bottom} gap={2} mt={16} mb={16}>
                    ...
                    <Grid item container xs={12} md={5} lg={5} textAlign={["center", "center", "start"]}>
                        ...
                        <Grid item xs={12}>
                            <Button LinkComponent={RouterLink} to="/register" color="hOrange" variant="contained">
                                Sign up now!
                            </Button>
                        </Grid>
                    </Grid>
